...
| Calendar events                        | `GET /api/v1/athlete/{id}/events?oldest=&newest=&category=`                               | Planned workouts; `category=FOLDER` vs `TARGET`; `resolve` param                                                                                                               |
| Event detail                           | `GET /api/v1/athlete/{id}/events/{eventId}`                                               | Includes `icu_training_load`, `icu_ctl`, `icu_atl`, `workout_doc`                                                                                                              |
| Sport settings (FTP, zones)            | `GET /api/v1/athlete/{id}/sport-settings`                                                 | Baseline values                                                                                                                                                                |
