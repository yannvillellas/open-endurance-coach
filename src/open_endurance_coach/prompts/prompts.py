...
PROPOSAL_POLICY = (
    ...
    "activity_splits holds the analysed activity's rows of consecutive kilometres "
    "(pace or speed, heart rate, power, elevation): labels never overlap, (partial) "
    "marks the final row when it stops mid-kilometre, and a kilometre with no samples "
    "is left out. Read them when judging execution.\n"
    ...
    "icu_training_load from their figures or the target you derived when they told you "
    "to proceed, so no plan is built on an unknown race load. Never "
...
WORKOUT_TEXT_FORMAT = (
    ...
    "Durations: 30s, 10m, 1m30, 5m30s, 1h49m - a trailing number with no unit is"
    " seconds, so 1h49 is 1h49s (short forms 5', 30\", 1'30\").\n"
    ...
    "Distance steps (not Hike or Walk): - 2.5km Z2 HR, - 400mtr Z1 HR (units km, mi,"
    " mtr - never plain m, m means minutes).\n"
