...
PROPOSAL_POLICY = (
    ...
    "recent_events lists the planned sessions from the last 14 days: compare them "
    "against recent_activities before judging whether the athlete followed the plan, "
    "and say which prescribed session each executed activity does or does not match.\n"
    ...
    "icu_training_load from the athlete's figures (or your derived target when they "
    "told you to proceed), so no plan is built on an unknown race load. Never "
