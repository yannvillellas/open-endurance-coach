...
PROPOSAL_POLICY = (
    ...
    "activity_splits holds the per-kilometre split rows of the analysed activity "
    "(pace or speed, heart rate, power, elevation): read them when judging execution, "
    "knowing the rows are merged or dropped for long activities or under budget "
    "pressure.\n"
