...
CHAT_DIRECTIVE = (
    ...
    "Default to discussion: propose a calendar change only when the athlete asks for one"
    " (plan, schedule, create, add, adjust, taper). Otherwise answer, and if a change"
    " would help, offer it as a question.\n"
